...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3" action="/jenisBantuan" method="POST">
            @csrf
            <div class="col-md-12">
                <label for="bantuan" class="form-label">Bantuan</label>
                <input type="text" class="form-control @error('bantuan')
                    is-invalid
                @enderror" id="bantuan" name="bantuan" value="{{ old('bantuan') }}">
                @error('bantuan')
            ...
            <div class="col-md-4">
                ...
                <div class="form-check form-check-inline mt-2">
                    ...
                    @enderror" type="radio" name="tahapan" id="tahapan" value="1" {{--autoautoauto autoautoauto --}}
                        @if(old('tahapan')=='1' ) checked @endif>
                ...
                <div class="form-check form-check-inline">
                    ...
                    @enderror" type="radio" name="tahapan" id="tahapan" value="2" {{--autoautoautoautoautoauto --}}
                        @if(old('tahapan')=='2' ) checked @endif>
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control @error('tgl_mulai')
                    is-invalid
                @enderror" id="tgl_mulai" name="tgl_mulai" value="{{ old('tgl_mulai') }}">
                @error('tgl_mulai')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control @error('tgl_selesai')
                    is-invalid
                @enderror" id="tgl_selesai" name="tgl_selesai" value="{{ old('tgl_selesai') }}">
                @error('tgl_selesai')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
