...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3" action="/keluarga/{{ $keluarga->no_kk }}" method="POST">
            @method('put')
            @csrf
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('no_kk')
                    is-invalid
                @enderror" id="no_kk" name="no_kk" value="{{ old('no_kk', $keluarga->no_kk) }}">
                @error('no_kk')
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('kepala_keluarga')
                    is-invalid
                @enderror" id="kepala_keluarga" name="kepala_keluarga"
            ...
            <div class="col-md-1">
                ...
                <input type="text" class="form-control @error('rt')
                    is-invalid
                @enderror" id="rt" name="rt" value="{{ old('rt', $keluarga->rt) }}">
                @error('rt')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-1">
                ...
                <input type="text" class="form-control @error('rw')
                    is-invalid
                @enderror" id="rw" name="rw" value="{{ old('rw', $keluarga->rw) }}">
                @error('rw')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control @error('dusun')
                    is-invalid
                @enderror" id="dusun" name="dusun" value="{{ old('dusun', $keluarga->dusun) }}">
                @error('dusun')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('desa')
                    is-invalid
                @enderror" id="desa" name="desa" value="{{ old('desa', $keluarga->desa) }}">
                @error('desa')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control @error('kode_pos')
                    is-invalid
                @enderror" id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $keluarga->kode_pos) }}">
                @error('kode_pos')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('kecamatan')
                    is-invalid
                @enderror" id="kecamatan" name="kecamatan" value="{{ old('kecamatan', $keluarga->kecamatan) }}">
                @error('kecamatan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('kabupaten_kota')
                    is-invalid
                @enderror" id="kabupaten_kota" name="kabupaten_kota"
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('provinsi')
                    is-invalid
                @enderror" id="provinsi" name="provinsi" value="{{ old('provinsi', $keluarga->provinsi) }}">
                @error('provinsi')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
