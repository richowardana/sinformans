                        ...
                        <td>
                            <center>
                                <table>
                                    <tr>
                                        <td>
                                            <a href="/detailKeluarga/{{ $anggotaKeluarga->id }}" data-bs-toggle="modal"
                                ...
                                <div class="modal-body">
                                    <form class="row g-3" action="/detailKeluarga/{{ $anggotaKeluarga->id }}"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="keluarga_id" id="keluarga_id"
                                                value="{{ $anggotaKeluarga->no_kk }}" disabled>
