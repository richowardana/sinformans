...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3" action="/penduduk" method="POST">
            @csrf
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control @error('tgl_lahir')
                    is-invalid
                @enderror" id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir') }}">
                @error('tgl_lahir')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-4">
                ...
                @enderror" name="pendidikan">
                    ...
                    <option value="SMP/Sederajat" @if (old('pendidikan')=='SMP/Sederajat' ) selected @endif>
                        SMP/Sederajat</option>
                    <option value="SMA/Sederajat" @if (old('pendidikan')=='SMA/Sederajat' ) selected @endif>
                        SMA/Sederajat</option>
                    <option value="D1/D2" @if (old('pendidikan')=='D1/D2' ) selected @endif>D1/D2</option>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control @error('pekerjaan')
                    is-invalid
                @enderror" id="pekerjaan" name="pekerjaan" value="{{ old('pekerjaan') }}">
                @error('pekerjaan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="col-md-4">
                ...
                @enderror" name="status">
                    <option value="">- Pilih Satu -</option>
                    <option value="Belum Menikah" @if (old('status')=='Belum Menikah' ) selected @endif>Belum Menikah
                    </option>
                    <option value="Menikah" @if (old('status')=='Menikah' ) selected @endif>Menikah</option>
                    <option value="Cerai" @if (old('status')=='Cerai' ) selected @endif>Cerai</option>
                </select>
                @error('status')
                <div class="invalid-feedback">
                    {{ $message }}
