    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                {{ $qrcode }}
                {{-- <h4>{{ $penduduk->nama }}</h4>
                <h5 class="text-success fw-bold">{{ $penduduk->pekerjaan }}</h5> --}}
                <a href="/penduduk">
                    <button type="button" class="btn btn-sm btn-primary rounded-pill mt-4">
                        <div class="icon">
            ...
            <div class="card-body pt-3">
                ...
                <div class="tab-content pt-2">
                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">NIK</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->nik }}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Nama</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->nama }}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Jenis Kelamin</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->jenis_kelamin}}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Kota Lahir</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->tempat_lahir }}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Tanggal Lahir</div>
                            <div class="col-lg-9 col-md-8"> : {{ date('d F Y', strtotime($penduduk->tgl_lahir))
                                }}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Agama</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->agama }}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Pendidikan</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->pendidikan }}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Pekerjaan</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->pekerjaan }}</div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-md-4 label mb-3">Status</div>
                            <div class="col-lg-9 col-md-8"> : {{ $penduduk->status }}</div>
                        </div>
                        ...
                        <form>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="pt-2"> <a href="#" class="btn btn-primary btn-sm"
                                            ...
                                            href="#" class="btn btn-danger btn-sm" title="Remove my profile image"><i
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9"> <input name="company" type="text" class="form-control"
                                        id="company" value="Therichpost"></div>
                            </div>
                            <div class="row mb-3">
                                <label for="Job" class="col-md-4 col-lg-3 col-form-label">Job</label>
                                <div class="col-md-8 col-lg-9"> <input name="job" type="text" class="form-control"
                                        id="Job" value="Web Designer"></div>
                            </div>
                            <div class="row mb-3">
                                <label for="Country" class="col-md-4 col-lg-3 col-form-label">Country</label>
                                <div class="col-md-8 col-lg-9"> <input name="country" type="text" class="form-control"
                                        id="Country" value="USA"></div>
                            </div>
                            <div class="row mb-3">
                                <label for="Address" class="col-md-4 col-lg-3 col-form-label">Address</label>
                                <div class="col-md-8 col-lg-9"> <input name="address" type="text" class="form-control"
                                        id="Address" value="Ludhiana, Punjab, India"></div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9"> <input name="email" type="email" class="form-control"
                                        id="Email" value="k.anderson@example.com"></div>
                            </div>
                            <div class="row mb-3">
                        ...
                        <form>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="form-check"> <input class="form-check-input" type="checkbox"
                                            id="proOffers"> <label class="form-check-label" for="proOffers"> Marketing
                                            and promo offers </label></div>
                                    <div class="form-check"> <input class="form-check-input" type="checkbox"
